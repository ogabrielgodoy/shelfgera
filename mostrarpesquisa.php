    ...
    <section class="section dashboard">
      <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="card-body">
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><a href="listarprodutos.php" label class="btn btn-primary">Mostrar todos</label></a></th>
              ...
              $pesq=$_SESSION['pesq'];
              $sql="SELECT * FROM tblivros WHERE skulivro = '$pesq'";
              $resultado=mysqli_query($conn,$sql);

              if(mysqli_num_rows($resultado) == 1){
                $regi=mysqli_fetch_array($resultado);
              ?>
                    <tbody>
                      <th></th>
                      <tr>
                   ...
                   <input type="submit" name="enviar" class="btn btn-outline-danger" value="Apagar">
                        ...
                        <td><img src="<?php echo $pasta . $regi['imagemlivro']; ?>" height="150px"></td>
...
<?php }else{
              ...
              $sql="SELECT * FROM tblivros WHERE nomelivro = '$pesq'";
              $resultado=mysqli_query($conn,$sql);
