        ...
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">ShelfGera</span>
                </a>
              </div><!-- End Logo -->
            ...
            <?php unset($_SESSION['msg_certo']);} ?>
                  ...
                  <form action="scripts/processarlogin.php" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <input class="btn btn-primary w-100" name="entrar" id="entrar" type="submit" value="Entrar">
                    </div>
